...
3. 区块生产者不得通过所有权，协议或协调行为与其他区区块生产者共享控制权<a id="footnote-ref-8"></a> [\[9\]](#footnote-8).大区块生产者应公布其集团的综合时间表和最终受益人名单，利息为10％或以上.
...
1. 可执行仲裁员的裁决另有说明<a id="footnote-ref-9"></a> [\[10\]](#footnote-9);
...
2. 区区块生产者意识到明显违反了代码的意图或一方或第三方的权利或其威胁，而没有其他方法可以阻止或防止此类违规行为.在这种情况下，这样的区块生产者必须立即通知另一个活动区块生产者和所选择的仲裁系统. <a id="footnote-ref-10"></a> [\[11\]](#footnote-10).
5. Block producers must comply with the award provided through the selected arbitration system.
5. 区块生产者必须遵守通过选定的仲裁系统提供的奖励.
